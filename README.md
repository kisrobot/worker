...
Once registered with [QOR Admin](http://github.com/kisrobot/admin), [Worker](https://github.com/kisrobot/worker) will provide a `Workers` section in the navigation tree, containing pages for listing and managing the following aspects of Workers:
...
[![GoDoc](https://godoc.org/github.com/kisrobot/worker?status.svg)](https://godoc.org/github.com/kisrobot/worker)

## Usage

```go
import "github.com/kisrobot/worker"
